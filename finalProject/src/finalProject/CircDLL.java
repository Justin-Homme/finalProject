...
/**
 * A class to create Circularly Doubly-linked lists of objects with generic type T
 * @author Justin Homme
 * @version 12/10/21
 * @param <T>
 */
public class CircDLL<T> {
	...
	/**
	 * a constructor for a SortedLinkedList with no parameters
	 * since we always want our list to start with only a head, 
	 * tail, and size zero
	 */
	public CircDLL() {
		clear();
	...
	/**
	 * a class of the nodes (of generic type T) that we will store
	 * in our SortedLinkedList
	 * @author gosnat
	 * @author Justin Homme
	 *
	 */
	...
	//methods below are not used in this class, currently but may be used in the future:
